...
# runs simulation without showing enemy fight to reduce runtime

headless = True
if headless: os.environ["SDL_VIDEODRIVER"] = "dummy"

# specifies folder where to save results
...
#load environment with specified parameters

env = Environment(experiment_name=experiment_name,
                  multiplemode="yes", # multiple enemies
                  enemies=[2, 5],  # array with 1 to 8 items
                  playermode="ai",
